<%-- 
    Document   : index.jsp
    Created on : Aug 17, 2023, 11:58:07 AM
    Author     : ShubhamVerma
--%>
...
<head>
    ...
    <!-- <body data-layout="horizontal"> -->
                            ...
                            <div class="w-100">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        ...
                                        <form action="./login-auth" method="POST" class="mt-4 pt-2">
                                            <div class="mb-3">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col">
                                                    <div class="">
                                                    <a href="Forgot-Password-Request" class="form-check-label">Forgot Password?</a>
                                            ...
                                            <div class="mb-3">
                                                <input class="btn btn-primary w-100 waves-effect waves-light" value="Log In" type="submit"></input>
                                            </div>
                                        </form>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Don't have an account ? <a href="User-register"
                    ...
                    <div class="col-xxl-9 col-lg-8 col-md-7">
                        <div class="auth-bg pt-md-5 p-4 d-flex">
                            ...
                            <div class="row justify-content-center align-items-center">
                                <div class="col-xl-7">
                                    <div id="show" class="card-body hidepopup">
                                        <div class="modal bs-example-modal" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">This massage be Alert</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" onclick="closePopup()" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <p>Please Enter Right UserID and Password</p>
                                                    </div>
                                                </div><!-- /.modal-content -->
                                            </div><!-- /.modal-dialog -->
                                        </div><!-- /.modal -->
        ...
        const code = urlParams.get('invalidCreds');
        if("Y" === code){
    ...
    function closePopup(){
         window.location.href = 'http://localhost:8080/testing_proj/';
    }
     </script>
